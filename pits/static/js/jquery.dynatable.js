  ...
  function RecordsCount(obj, settings) {
    ...
    this.create = function() {
      ...
      if (recordsShown < recordsQueryCount && settings.features.paginate) {
        ...
        text += "<span class='dynatable-record-bounds'>" + (bounds[0] + 1) + " de " + bounds[1] + "</span> de um total de ";
      } else if (recordsShown === recordsQueryCount && settings.features.paginate) {
        text += recordsShown + " de ";
      }
      text += recordsQueryCount + " " + collection_name;
      if (recordsQueryCount < recordsTotal) {
        text += " (Filtrados de um total de " + recordsTotal + " registros)";
      }
  ...
  function PaginationPerPage(obj, settings) {
    ...
    this.create = function() {
      ...
      for (var i = 0, len = settings.dataset.perPageOptions.length; i < len; i++) {
        ...
        $select.append('<option value="'+ number + '" ' + selected + '>'+"Número de registros a visualizar " + number + '</option>');
      }
